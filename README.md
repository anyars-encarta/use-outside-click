...
<div align="center">
 ...
 <!-- LOGO -->
  ...
  <img src="./src/assets/use-outside-click.JPG" alt="logo" width="160"  height="auto" />
  <br/>

<!-- MAIN HEADING -->

  <h3><b>Use Outside Click</b></h3>
...
<!-- INTRO -->
# 📖 Use Outside Click<a name="about-project"></a>

> Use Outside Click is an interactive app that opens a popup window. The window closes when the user clicks outside of the window.
...
> - Open a popup window
> - Close the popup window when user clicks outside the window
...
https://github.com/anyars-encarta/use-outside-click.git
```
